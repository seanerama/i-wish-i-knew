...
const MESSAGES: Record<string, string> = {
  ...
  challenge_resolved: 'this challenge is already resolved',
  csrf_failed: 'form token missing or stale; reload the page and try again',
  feature_disabled: 'this feature is disabled on this deployment',
  internal: 'internal error',
  name_taken: 'an organization with that name already exists',
  node_revoked: 'the node behind this token has been revoked',
  not_found: 'resource not found',
  not_ready: 'service is not ready',
  outcome_exists: 'this prediction already has its observation recorded',
  prediction_immutable: 'a registered prediction cannot be altered; report the observation only',
  ...
  rate_limited: 'too many attempts; retry after the indicated delay',
  run_conflict: 'run_id already exists with different content',
  scope_required: 'token lacks the required scope',
  target_mismatch:
    'the observation names a different target or receipt than the registered prediction',
